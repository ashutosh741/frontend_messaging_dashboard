...
import { API, pdfCompanyName } from "../../../utils/constants.js";
    ...
    <>
      {TOKEN ? (
          ...
          <>
            <div className="bg-base-100  p-6 rounded-lg shadow-lg">
              <p className="text-lg font-semibold mb-4">
                🌟 Welcome to <strong>{pdfCompanyName}!</strong> 🌟
              </p>
              ...
              {user.role?.includes("HR") ? (
                <ol className="list-decimal pl-6 mb-4">
                  <li className="mb-2">
                    ...
                    your attendance promptly between 05:00 AM and 10:00 AM
                    daily. This is crucial for lead assignment and maintaining
                    team coordination. Late attendance may impact lead
                    allocation. If you encounter any issues or have questions,
                    feel free to contact your team leader,{" "}
                    <strong>{TLname} </strong>, at {TLcontact}.
                  </li>
                  <li className="mb-2">
              ...
              <p className="text-sm mt-4">Best regards, {pdfCompanyName}</p>
            </div>
          </>
        ) : (
          <div className="bg-base-100  p-6 rounded-lg shadow-lg">
        ...
        <>
          ...
          <p className="text-lg mt-6">
            Ready to boost your career? Join {pdfCompanyName} today! Get Started
          </p>
        </>
      )}
    </>
